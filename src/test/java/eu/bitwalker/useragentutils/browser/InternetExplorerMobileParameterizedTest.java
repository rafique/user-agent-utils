	...
	public static Collection<Object[]> testData() {
		return asList(new Object[][] {
				// ieMobile6
				{
						...
						Browser.IEMOBILE6, "6.12", OperatingSystem.WINDOWS_MOBILE },
				{
						...
						Browser.IEMOBILE6, "6.12", OperatingSystem.WINDOWS_MOBILE },
				{
						...
						Browser.IEMOBILE6, "6.8", OperatingSystem.WINDOWS_MOBILE },
				// ieMobile7
				{
						"HTC_TouchDual Mozilla/4.0 (compatible; MSIE 6.0; Windows CE; IEMobile 7.6)",
						Browser.IEMOBILE7, "7.6", OperatingSystem.WINDOWS_MOBILE },
				{
